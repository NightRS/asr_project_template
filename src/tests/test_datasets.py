...
class TestDataset(unittest.TestCase):
    def test_librispeech(self):
        config_parser = ConfigParser.get_test_configs(run_name="test_librispeech")
    ...
    def test_custom_dir_dataset(self):
        config_parser = ConfigParser.get_test_configs("test_custom_dir_dataset")
        with clear_log_folder_after_use(config_parser):
    ...
    def test_custom_dataset(self):
        config_parser = ConfigParser.get_test_configs(run_name="test_custom_dataset")
        with clear_log_folder_after_use(config_parser):
